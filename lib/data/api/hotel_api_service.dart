...
class HotelApiService {
  ...
  Future<HotelSearchModel> searchHotels(Map<String, dynamic> searchParams) async {
    try {
  ...
  Future<HotelData> getHotelDetails(String hotelCode, Map<String, dynamic> searchParams) async {
    try {
